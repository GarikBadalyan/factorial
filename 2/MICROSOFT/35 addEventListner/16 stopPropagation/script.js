...
const chyld = document.getElementById("chyld")
parent.addEventListener("click",func1)
chyld.addEventListener("click",func2)
function func1(){
  console.log("es parentn em")
}
function func2(event){
  console.log("es chyldn em")
  event.stopPropagation()// erb event.stopPropagation -@ hanenq u sexmenq chyldi vra consolum erkusn el ktpi
  //isk  ays depqum ktpi miayn  "es chyldn em"
}
