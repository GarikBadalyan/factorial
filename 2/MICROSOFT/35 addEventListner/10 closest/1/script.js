...
function myfunc(event) {
  let li = event.target.closest("li")//aysinqn ays hramani mijocov ete tarberakneric voreve mek@ motik che apa
  // click aneluc vocinch chi texi unena aranc closest - i ktper sax
