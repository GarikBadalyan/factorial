...
search_button.addEventListener("click", cuycTurPassword);

function cuycTurPassword() {
  password.type = "text";//passwordi typ@ darcra text aysinqn tesaneli
  search_button.innerHTML = "hiden";//search_buttoni miji exac@ poxir darcra hiden aysinqn taqcnel
  search_button.removeEventListener("click", cuycTurPassword);// remove ara ays iradarcutyun@
  search_button.addEventListener("click", taqcraPassword);//kanchir ays myus iradarcutyun@
}

function taqcraPassword() {
  password.type = "password";
  search_button.innerHTML = "Show";
  search_button.removeEventListener("click", taqcraPassword);
  search_button.addEventListener("click", cuycTurPassword);
}
