...
text.addEventListener("keydown", func);

function func(event) {
  console.log(event.key + " " + event.code);//event.code -@ cuyc e talis sexmac iskakan klavish@ ete lezun poxenq 
  // ruseren u sexmenq a apa event.key cuyc kta ф isk event.code -@ cuyc kta keyA
}
/*
