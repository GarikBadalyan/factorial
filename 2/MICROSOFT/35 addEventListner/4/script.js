...
link.addEventListener("click", myfunc1);
function myfunc1() {
  alert("Hello");
}
let inp = document.querySelector("input");
inp.addEventListener("click", myfunc2);
...
window.addEventListener("click", function (event) {
  console.log(event.clientX, event.clientY, event.pageX, event.pageY,event.screenX,event.offsetX);
});
//clientX,clientY srank koordinatnern en @st brouzeri patuhani isk pageX pajeY @st Html documenti
/*
